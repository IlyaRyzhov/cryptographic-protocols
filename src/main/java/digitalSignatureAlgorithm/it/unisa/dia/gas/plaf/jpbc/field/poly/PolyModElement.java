package digitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.field.poly;
...
public class PolyModElement<E extends Element> extends AbstractPolyElement<E, PolyModField> {
    ...
    PolyModElement(PolyModField field) {
        super(field);
    ...
    private PolyModElement(PolyModElement<E> source) {
...
*/
    ...
    PolyModElement<E> setFromPolyTruncate(PolyElement<E> element) {
     ...
     * @param scratch
     */
    private void kar_poly_2(List<E> dst, Element c3, Element c4, List<E> s1, List<E> s2, List<E> scratch) {
        Element c01, c02, c12;
    ...
    private PolyElement polyInvert(PolyElement f) {
