...
import digitalSignatureAlgorithm.it.unisa.dia.gas.jpbc.Polynomial;
...
public class TypeFTateNoDenomMillerPairingMap extends AbstractMillerPairingMap {
    private final TypeFPairing pairingData;
    ...
    private Element tateExp(Polynomial element) {
    ...
    private Element pairing(Point P, Point Qx, Point Qy) {
        Element Px = P.getX();
        Element Py = P.getY();
    ...
    private void millerStep(Polynomial e0, Polynomial v, Element a, Element b, Element c, Element Qx, Element Qy) {
        // a, b, c lie in Fq
        // Qx, Qy lie in Fq^2
    ...
    private void millerStepTerm(int i, int j, int k, int flag,
