...
import digitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.field.base.AbstractFieldOver;
...
public class PolyModField<F extends Field> extends AbstractFieldOver<F, PolyModElement> {
    final PolyElement irreduciblePoly;
    private PolyModElement nqr;
    private BigInteger order;
    int n;
    private int fixedLengthInBytes;
    ...
    private void init(BigInteger nqr) {
