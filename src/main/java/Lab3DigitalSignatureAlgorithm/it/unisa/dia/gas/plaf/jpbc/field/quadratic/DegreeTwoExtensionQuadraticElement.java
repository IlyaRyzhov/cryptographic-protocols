package Lab3DigitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.field.quadratic;
...
public class DegreeTwoExtensionQuadraticElement<E extends Element> extends QuadraticElement<E> {
    ...
    DegreeTwoExtensionQuadraticElement(DegreeTwoExtensionQuadraticField field) {
        super(field);
    ...
    private DegreeTwoExtensionQuadraticElement(DegreeTwoExtensionQuadraticElement element) {
    ...
    public DegreeTwoExtensionQuadraticElement sqrt() {
        //if (a+bi)^2 = x+yi then
        //2a^2 = x +- sqrt(x^2 + y^2)
        //(take the getSignature such that a exists) and 2ab = y
