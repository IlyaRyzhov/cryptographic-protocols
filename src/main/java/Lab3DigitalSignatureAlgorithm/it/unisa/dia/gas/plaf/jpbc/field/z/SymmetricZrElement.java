package Lab3DigitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.field.z;

import Lab3DigitalSignatureAlgorithm.it.unisa.dia.gas.jpbc.Element;
import Lab3DigitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.util.Arrays;
...
public class SymmetricZrElement<F extends SymmetricZrField> extends AbstractZElement<F> {
    ...
    private final BigInteger halfOrder;


    SymmetricZrElement(F field) {
        super(field);
    ...
    private SymmetricZrElement(SymmetricZrElement<F> zrElement) {
...
//        this.value = value.multiply(BigIntegerUtils.TWO).mod(order);
    ...
    public SymmetricZrElement setToRandom() {
        this.value = BigIntegerUtils.getRandom(order);
