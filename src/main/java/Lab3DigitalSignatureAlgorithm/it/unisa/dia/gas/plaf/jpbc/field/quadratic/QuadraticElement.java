...
import Lab3DigitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.field.base.AbstractPointElement;
...
public class QuadraticElement<E extends Element> extends AbstractPointElement<E, QuadraticField> {
    ...
    QuadraticElement(QuadraticField field) {
        super(field);
    ...
    private QuadraticElement(QuadraticElement element) {
