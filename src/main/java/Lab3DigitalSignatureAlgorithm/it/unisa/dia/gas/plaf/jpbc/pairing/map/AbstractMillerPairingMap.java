...
import Lab3DigitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.util.io.PairingStreamReader;
...
//        a.add(a).add(a);
    ...
    public static class MillerPreProcessingInfo {
        ...
        MillerPreProcessingInfo(int size) {
            this.table = new Element[size][3];
        }

        MillerPreProcessingInfo(Pairing pairing, byte[] source, int offset) {
            PairingStreamReader in = new PairingStreamReader(source, offset);
