package Lab3DigitalSignatureAlgorithm.it.unisa.dia.gas.plaf.jpbc.pairing.a1;
...
public class TypeA1TateNafProjectiveMillerPairingMap extends AbstractMillerPairingMap {
    ...
    private void tatePow(Point out, Point in) {
        out.set(in).invert();
        in.getY().negate();
        in.mul(out);
...
//        u.getY().set(z3.duplicate().mul(Q.getY()));
    ...
    public class TypeA1TateNafProjectiveMillerPairingPreProcessing extends AbstractMillerPairingPreProcessing {
        ...
        TypeA1TateNafProjectiveMillerPairingPreProcessing(byte[] source, int offset) {
            super(pairing, source, offset);
        }

        TypeA1TateNafProjectiveMillerPairingPreProcessing(Point in1) {
