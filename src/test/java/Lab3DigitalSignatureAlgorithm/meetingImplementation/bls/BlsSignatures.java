package Lab3DigitalSignatureAlgorithm.meetingImplementation.bls;
...
import Lab3DigitalSignatureAlgorithm.meetingImplementation.bls.model.BlsModel;
import Lab3DigitalSignatureAlgorithm.meetingImplementation.bls.model.Signature;
import Lab3DigitalSignatureAlgorithm.meetingImplementation.bls.utils.Sha256Hash;
...
public class BlsSignatures {
    ...
    private byte[] hash(byte[] message, Element publicKey) {
        return Sha256Hash.hash(message);
    }
}
