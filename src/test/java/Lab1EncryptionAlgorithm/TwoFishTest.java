...
public class TwoFishTest {
    ...
    @Test
    @DisplayName("Шифровка одного блока при ключе из 192 бит")
    ...
    @Test
    @DisplayName("Шифровка одного блока при ключе из 256 бит")
